...
namespace JelleDruyts.BuildCop.Rules.OrphanedProjects.Configuration
{
    /// <summary>
    /// Defines the configuration for the <see cref="JelleDruyts.BuildCop.Rules.OrphanedProjects.OrphanedProjectsRule"/>.
    /// </summary>
