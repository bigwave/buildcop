...
using JelleDruyts.BuildCop.Rules.BuildProperties.Configuration;
using JelleDruyts.BuildCop.Rules.NamingConventions.Configuration;
using JelleDruyts.BuildCop.Rules.StrongNaming.Configuration;
using JelleDruyts.BuildCop.Test.Mocks;
using JelleDruyts.BuildCop.Rules.BuildProperties;
...
namespace JelleDruyts.BuildCop.Test
{
    ...
    public class ConfigurationTest
    {
        ...
        public void ConfigurationFileShouldBeReadCorrectly()
        {
            ...
            Assert.AreEqual<string>("JelleDruyts.BuildCop.Rules.AssemblyReferences.AssemblyReferenceRule", asmRefRule.Type);
            ...
            Assert.AreEqual<string>("JelleDruyts.BuildCop.Rules.StrongNaming.StrongNamingRule", strongNamingRule.Type);
            ...
            Assert.AreEqual<string>("JelleDruyts.BuildCop.Rules.NamingConventions.NamingConventionsRule", namingConventionsRule.Type);
            ...
            Assert.AreEqual<string>("JelleDruyts.BuildCop.Rules.BuildProperties.BuildPropertiesRule", buildPropertiesRule.Type);
            ...
            Assert.AreEqual<string>("JelleDruyts.BuildCop.Rules.DocumentationFile.DocumentationFileRule", documentationFileRule.Type);
            ...
            Assert.AreEqual<string>("JelleDruyts.BuildCop.Rules.OrphanedProjects.OrphanedProjectsRule", orphanedProjectsRule.Type);
            ...
            Assert.AreEqual<string>("JelleDruyts.BuildCop.Rules.DocumentationFile.DocumentationFileRule", sharedDocumentationFileRule.Type);
            ...
            Assert.AreEqual<string>("JelleDruyts.BuildCop.Formatters.Console.ConsoleFormatter", consoleFormatter.Type);
            ...
            Assert.AreEqual<string>("JelleDruyts.BuildCop.Formatters.Html.HtmlFormatter", htmlFormatter.Type);
            ...
            Assert.AreEqual<string>("JelleDruyts.BuildCop.Formatters.Xml.XmlFormatter", xmlFormatter.Type);
            ...
            Assert.AreEqual<string>("JelleDruyts.BuildCop.Formatters.Csv.CsvFormatter", csvFormatter.Type);
        ...
        {
            DerivedRuleElement.Deserialize("<rule name=\"MockRule\" type=\"JelleDruyts.BuildCop.Test.Mocks.MockRule, JelleDruyts.BuildCop.Test\"><dummy/></rule>");
        }
        ...
        {
            DerivedRuleElement.Deserialize("<rule name=\"MockRule\" type=\"JelleDruyts.BuildCop.Test.Mocks.MockRuleInvalid, JelleDruyts.BuildCop.Test\"><dummy/></rule>");
        }
        ...
        {
            DerivedRuleElement.Deserialize("<rule name=\"MockRule\" type=\"JelleDruyts.BuildCop.Test.Mocks.MockRuleInvalidConfigurationType, JelleDruyts.BuildCop.Test\"><dummy/></rule>");
        }
        ...
        {
            DerivedRuleElement.Deserialize("<rule name=\"MockRule\" type=\"JelleDruyts.BuildCop.Test.Mocks.MockRuleInvalidConfigurationDefinition, JelleDruyts.BuildCop.Test\"><dummy/></rule>");
        }
    }
}