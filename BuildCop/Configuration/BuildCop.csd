...
<configurationSectionModel xmlns:dm0="http://schemas.microsoft.com/VisualStudio/2008/DslTools/Core" dslVersion="1.0.0.0" Id="42371a6d-0484-4e82-bdd2-32961e8381ad" namespace="BuildCop.Configuration" xmlSchemaNamespace="http://schemas.jelle.druyts.net/BuildCop" xmlns="http://schemas.microsoft.com/dsltools/ConfigurationSectionDesigner">
  <typeDefinitions>
    ...
    <enumeratedType name="LogLevel" namespace="BuildCop.Reporting" documentation="Specifies log levels for log entries.">
      <literals>
  ...
  <configurationElements>
    ...
    <configurationElement name="FormatterElement" documentation="Defines a formatter for a BuildCop report." hasCustomChildElements="true">
      <attributeProperties>
        ...
        <attributeProperty name="MinimumLogLevel" isRequired="false" isKey="false" isDefaultCollection="false" xmlName="minimumLogLevel" isReadOnly="false" documentation="The minimum log level this formatter should display." defaultValue="BuildCop.Reporting.LogLevel.Information">
          <type>
