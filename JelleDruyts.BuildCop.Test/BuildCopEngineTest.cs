...
namespace JelleDruyts.BuildCop.Test
{
    ...
    public class BuildCopEngineTest
    {
        ...
        [TestMethod]
        [ExpectedException(typeof(ConfigurationErrorsException), "The rule type must have a constructor that takes a RuleConfigurationElement. Type name: JelleDruyts.BuildCop.Test.Mocks.MockRuleInvalid")]
        ...
        [TestMethod]
        [ExpectedException(typeof(ConfigurationErrorsException), "The formatter type must have a default constructor. Type name: JelleDruyts.BuildCop.Test.Mocks.MockFormatterInvalid")]
